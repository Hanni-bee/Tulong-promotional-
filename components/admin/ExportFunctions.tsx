...
export default function ExportFunctions({ users, filteredUsers }: ExportFunctionsProps) {
  ...
  return (
    <div className="flex gap-2 flex-wrap">
      <button
        onClick={exportToCSV}
        className="px-3 py-2 bg-emerald-600 text-white text-sm font-normal rounded-md hover:bg-emerald-700 transition-all border border-emerald-700/50 flex items-center gap-1.5 active:scale-95"
      >
      ...
      <button
        ...
        className="px-3 py-2 bg-slate-600 text-white text-sm font-normal rounded-md hover:bg-slate-700 transition-all border border-slate-700/50 flex items-center gap-1.5 active:scale-95"
      >
        <DownloadIcon className="w-4 h-4" strokeWidth={2} />
        Excel
      </button>
      <button
        onClick={printView}
        className="px-3 py-2 bg-amber-600 text-white text-sm font-normal rounded-md hover:bg-amber-700 transition-all border border-amber-700/50 flex items-center gap-1.5 active:scale-95"
      >
        <PrintIcon className="w-4 h-4" strokeWidth={2} />
        Print
      </button>
    </div>
  );
